...
from models import EdgeNetAndRejector
...
optimizer = optim.SGD(edge_net.edge_net.parameters(), lr=0.001, momentum=0.9)
...
for epoch in range(15):  # loop over the dataset multiple times
    ...
    for i, data in enumerate(trainloader, 0):
        ...
        outputs = edge_net.edge_net(inputs)
...
torch.save(edge_net.state_dict(), save_dir / f'{dataset}-edgenet-only.pth')
...
torch.save(predicted_edge_e, save_dir / f'{dataset}-predicted_edge.pth')
