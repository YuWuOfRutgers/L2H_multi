...
from test_utils import get_accuracy, get_accuracy_remote, test_edge, test_local, test_edge_save_images_according_to_rejector
...
print("------------------ find the rejected samples ------------------")
labels, predicted_edge_r, predicted_edge_e = test_edge_save_images_according_to_rejector(edge_net, testloader)
# find the remote samples and local samples:
