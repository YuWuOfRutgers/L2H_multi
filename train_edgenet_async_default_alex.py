...
parser.add_argument("--edge_model", type=str, default="alexnet", help="edge model")
...
edge_net = EdgeNetAndRejector(len(trainset_full.classes), edge_net=args.edge_model).to(device)
